...
| `address`                     | Масив об’єктів  | Мінімум 1 елемент           | Так          |
| `address.*.lat`               | Число           | Діапазон: -90.00 - 90.00    | Так          |
| `address.*.lon`               | Число           | Діапазон: -180.00 - 180.00  | Так          |
| `address.*.{lang}.city`       | Рядок           | Максимум 255 символів       | Так          |
| `address.*.{lang}.regionName` | Рядок           | Максимум 255 символів       | Так          |
| `address.*.{lang}.address`    | Рядок           | Максимум 255 символів       | Так          |
